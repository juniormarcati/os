...
$pdf->Ln(5);
// OS details
$pdf->Cell(49,25,utf8_decode(""),0,0,'C');
$pdf->Ln(5);
$pdf->SetFont('Arial','B',14);
$pdf->Cell(50,2,utf8_decode("OS Nº $OsId"),0,0,'C');
$pdf->Ln(6);
$pdf->SetFont('Arial','B',5);
$pdf->Cell(13,2,utf8_decode("Empresa: "),0,0,'L');
$pdf->SetFont('Arial','',5);
$pdf->Multicell(40,2,utf8_decode("$EntidadeName"),0,'J');
$pdf->Ln();
$pdf->SetFont('Arial','B',5);
$pdf->Cell(13,2,utf8_decode("Requerente: "),0,0,'L');
$pdf->SetFont('Arial','',5);
$pdf->Cell(40,2,utf8_decode("$UserName"),0,0,'L');
$pdf->Ln();
$pdf->SetFont('Arial','B',5);
$pdf->Cell(13,2,utf8_decode("Responsável: "),0,0,'L');
$pdf->SetFont('Arial','',5);
$pdf->Cell(40,2,utf8_decode("$OsResponsavel"),0,0,'L');
$pdf->Ln(10);
// QR Code
